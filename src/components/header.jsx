...
//             <div
//               className="flex items-center gap-3 ml-4 mr-10 cursor-pointer"
//               onClick={() => setUpperScreen(true)}
//             >
//               <img
//                 src={currentUser.profile ? `${Backend_url}${currentUser.profile}` : "/defaultuser.JPG"}
//                 alt="avatar"
//                 className="h-12 w-12 border-2 border-black rounded-full object-cover transition-transform duration-200 hover:scale-125"
//               />
//               <div className="hidden sm:flex flex-col">
